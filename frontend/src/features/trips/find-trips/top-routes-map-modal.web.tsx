    ...
    >
      <View style={styles.screen}>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.mainText}>{webUnavailableTitle}</Text>
          <Text style={styles.subText}>{webUnavailableDescription}</Text>
          ...
          >
            <Text style={formStyles.secondaryButtonText}>{closeLabel}</Text>
          </Pressable>
        </View>
      </View>
    </Modal>
